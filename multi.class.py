...
from multi_helper_class import DataFetcher, ActionComputer, DataPlotter
...
parser.add_argument("-l", "--list", help="Path to file containing stock symbols, one per line", required=True)
